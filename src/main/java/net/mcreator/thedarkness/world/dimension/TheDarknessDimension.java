...
package net.mcreator.thedarkness.world.dimension;
...
public class TheDarknessDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("the_darkness:the_darkness"), customEffect));
		}
	}
}
