 ...
 *
 */
package net.mcreator.thedarkness;
...
@Mod("the_darkness")
public class TheDarknessMod {
	public static final Logger LOGGER = LogManager.getLogger(TheDarknessMod.class);
	public static final String MODID = "the_darkness";

	public TheDarknessMod() {
